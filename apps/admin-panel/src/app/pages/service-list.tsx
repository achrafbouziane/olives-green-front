            ...
            {services.length === 0 ? (
              ...
              services.map((service) => (
                ...
                >
                  ...
                  <td className="p-4">
                    {/* Link to the DASHBOARD now */}
                    <Link to={`/services/${service.pageSlug}`}>
                      <button className="text-emerald-600 hover:text-emerald-800 font-bold flex items-center gap-1 px-4 py-2 rounded bg-emerald-50 hover:bg-emerald-100 transition-colors">
